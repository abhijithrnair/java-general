...
public class MergePointOfTwoJoinedLL {
    ...
    static int findMergeNode(SinglyLinkedListNode head1, SinglyLinkedListNode head2) {
        ...
        while(firstList!=null){
            while(secondList!=null){
                if(firstList.next==secondList.next){
                    return firstList.next.data;
                }
    ...
    SinglyLinkedListNode secondList = head2;
    while(firstList!=null){
       hashSet.add(firstList.next) ;
       firstList = firstList.next;
    }
    while(secondList!=null){
    if(hashSet.contains(secondList.next)){
        return secondList.next.data;
    }
    secondList=secondList.next;
    }
    return 0;*/
